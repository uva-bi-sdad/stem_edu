...
![OpenJobs Job Count Aggregates by Economic Region](../burn_glass_validation/Images/oj_map.JPG)

The above image was meant to be rendered in HTML to be interactive, but the below table represents the same information:
