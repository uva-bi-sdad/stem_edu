...
#
# Run the combining_ipeds.sql script before running below code
#

DBI::dbGetQuery(conn, 'SELECT hd2012_2017.unitid, hd2012_2017.instnm, hd2012_2017.addr, hd2012_2017.city,
